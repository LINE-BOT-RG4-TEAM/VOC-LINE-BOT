...
$NUMBER = $_GET['REQ'];
$NUMBER2 = $_GET['REQ2'];
$sql = "SELECT * , COUNT(office_name) AS NUM FROM tbl_authorize  WHERE (main_office LIKE '%".$NUMBER."%' OR office_name LIKE '%".$NUMBER."%')  AND number_of_day<=".$NUMBER2." GROUP BY office_name HAVING(COUNT(office_name)>0)";
